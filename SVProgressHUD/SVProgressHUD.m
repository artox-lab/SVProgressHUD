...
@property (nonatomic, strong, readonly) ALActivityIndicatorView *spinnerView;
...
- (ALActivityIndicatorView *)spinnerView {
    if (spinnerView == nil) {
        spinnerView = [[ALActivityIndicatorView alloc] initWithFrame:CGRectMake(0, 0, 76, 8)];
    }
